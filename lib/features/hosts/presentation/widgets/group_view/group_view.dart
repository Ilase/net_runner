                ...
                children: [
                  ...
                  Expanded(
                    child: AnimatedCrossFade(
                      firstChild: BlocBuilder<GroupListCubit, GroupListState>(
                      ...
                      secondChild: BlocBuilder<HostListCubit, HostListState>(
                        builder: (builder, state) {
                      ...
                      crossFadeState: _viewMode == InfoModes.edit
                          ? CrossFadeState.showSecond
                          : CrossFadeState.showFirst,
                      duration: Duration(milliseconds: 200),
                    ),
                    ...
                    OutlinedButton.icon(
                      onPressed: () {
                        ...
                        final body = {
                          ...
                          "description": _groupAddDescriptionController.text,
                          "hosts": hosts
                        };
